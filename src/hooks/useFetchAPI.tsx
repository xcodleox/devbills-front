...
setFinancialEvolution(financialEvolution)
    ...
    return (
        <FetchAPIContext.Provider value={{categories, transactions, createCategory, createTransaction, fetchCategories,
            fetchTransactions, fetchDashboard, dashboard, fetchFinancialEvolution, financialEvolution
        }}>
            {children}
